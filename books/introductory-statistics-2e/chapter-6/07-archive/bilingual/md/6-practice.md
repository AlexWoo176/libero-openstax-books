...
![Empty normal distribution curve.](../../../assets/img-6-5.webp)

Figure 
6.16
Hình 
6.16
1. *P*(0 < *x* < ____________) = ___________ (Use zero for the minimum value of *x*.)
...
1. Sketch the situation. Label and scale the axes. Shade the region corresponding to the probability.
![Empty normal distribution curve.](../../../assets/img-6-6.webp)
Figure 
6.17
Hình 
6.17
...
![Empty normal distribution curve.](../../../assets/img-6-7.webp)
Figure 
6.18
Hình 
6.18
1. *P*(*x* < *k*) = __________ Therefore, *k* = _________
