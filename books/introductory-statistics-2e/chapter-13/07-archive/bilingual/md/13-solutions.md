...
*H_a*: At least two of the group means *μ_1*, *μ_2*, *μ_3* are not equal.
...
1. *H_0*: *µ_L* = *µ_T* = *µ_J*
1. *H_0*: *µ_L* = *µ_T* = *µ_J*
1. *H_a*: at least any two of the means are different
1. *H_a*: ít nhất bất kỳ hai trong số các giá trị trung bình là khác nhau
1. *df*(*num*) = 2; *df*(*denom*) = 12
1. *df*(*tử*) = 2; *df*(*mẫu*) = 12
1. *F* distribution
1. Phân phối *F*
1. 0.67
...
1. *H_a*: *µ*_c = *µ*_n = *µ*_h
1. At least any two of the magazines have different mean lengths.
...
1. *H_0*: *μ_o* = *μ_h* = *μ_f*
1. *H_0*: *μ_o* = *μ_h* = *μ_f*
1. At least two of the means are different.
...
1. *H_0*: *μ_p* = *μ_m* = *μ_h*
1. *H_0*: *μ_p* = *μ_m* = *μ_h*
1. At least any two of the means are different.
...
*H*_a: *μ*_i ≠ *μ*_j some  *i* ≠ *j*.

*H*_a: *μ*_i ≠ *μ*_j một số *i* ≠ *j*.

Define *μ*_1, *μ*_2, *μ*_3, as the population mean number of eggs laid by the three groups of fruit flies.
