...
Độ lệch chuẩn luôn dương hoặc bằng không. Độ lệch chuẩn nhỏ khi tất cả dữ liệu tập trung gần số trung bình, cho thấy ít sự biến thiên hoặc độ phân tán. Độ lệch chuẩn lớn hơn khi các giá trị dữ liệu phân tán xa hơn so với số trung bình, cho thấy sự biến thiên nhiều hơn.
...
Vì siêu thị *B* có độ lệch chuẩn cao hơn, chúng ta biết rằng có sự biến thiên lớn hơn trong thời gian chờ tại siêu thị *B*. Nhìn chung, thời gian chờ tại siêu thị *B* phân tán nhiều hơn so với giá trị trung bình; thời gian chờ tại siêu thị *A* tập trung gần giá trị trung bình hơn.
...
Trục số có thể giúp bạn hiểu về độ lệch chuẩn. Nếu chúng ta đặt năm và bảy trên một trục số, bảy nằm bên phải của năm. Khi đó, chúng ta nói rằng bảy cách giá trị năm **một** độ lệch chuẩn về phía **bên phải** vì 5 + (1)(2) = 7.

If one were also part of the data set, then one is **two** standard deviations to the **left** of five because 5 + (–2)(2) = 1.

Nếu một cũng là một phần của tập dữ liệu, thì một cách giá trị năm **hai** độ lệch chuẩn về phía **bên trái** vì 5 + (–2)(2) = 1.
...
Để tính độ lệch chuẩn, trước tiên chúng ta cần tính phương sai. Phương sai là **trung bình các bình phương của các độ lệch** (các giá trị *x* – ̅̅̅̅̅𝑥x¯x¯ đối với một mẫu, hoặc các giá trị *x* – *μ* đối với một quần thể). Ký hiệu *σ*^2 đại diện cho phương sai quần thể; độ lệch chuẩn quần thể *σ* là căn bậc hai của phương sai quần thể. Ký hiệu *s*^2 đại diện cho phương sai mẫu; độ lệch chuẩn mẫu *s* là căn bậc hai của phương sai mẫu. Bạn có thể coi độ lệch chuẩn là một dạng trung bình đặc biệt của các độ lệch.
...
Số trung bình tuổi là 10,53 năm, được làm tròn đến hai chữ số thập phân.
...
Phương sai có thể được tính bằng cách sử dụng bảng. Sau đó, độ lệch chuẩn được tính bằng cách lấy căn bậc hai của phương sai. Chúng ta sẽ giải thích các phần của bảng sau khi tính toán *s*.
...
- Đối với các bài toán sau, hãy nhớ rằng **giá trị = số trung bình + (số độ lệch chuẩn)(độ lệch chuẩn)**. Hãy kiểm tra lại số trung bình và độ lệch chuẩn trên máy tính cầm tay hoặc máy tính cá nhân.
...
1. Hãy kiểm tra lại số trung bình và độ lệch chuẩn trên máy tính cầm tay hoặc máy tính cá nhân của bạn.
...
Các độ lệch cho thấy dữ liệu phân tán như thế nào quanh số trung bình. Giá trị dữ liệu 11,5 xa số trung bình hơn giá trị dữ liệu 11, điều này được thể hiện qua các độ lệch 0,97 và 0,47. Độ lệch dương xảy ra khi giá trị dữ liệu lớn hơn số trung bình, trong khi độ lệch âm xảy ra khi giá trị dữ liệu nhỏ hơn số trung bình. Độ lệch là –1,525 đối với giá trị dữ liệu chín. **Nếu bạn cộng các độ lệch, tổng luôn bằng không.** (Đối với [Ví dụ 2.32](2-7-measures-of-the-spread-of-the-data#element-655), có *n* = 20 độ lệch.) Vì vậy, bạn không thể chỉ đơn giản cộng các độ lệch để có được độ phân tán của dữ liệu. Bằng cách bình phương các độ lệch, bạn làm cho chúng trở thành các số dương, và tổng cũng sẽ là số dương. Do đó, phương sai là trung bình của các độ lệch bình phương.
...
Râu trái dài trong biểu đồ hộp được phản ánh ở phía bên trái của biểu đồ histogram. Độ phân tán của điểm thi trong 50% thấp hơn lớn hơn (73 – 33 = 40) so với độ phân tán trong 50% cao hơn (100 – 73 = 27). Biểu đồ histogram, biểu đồ hộp và bảng đều phản ánh điều này. Có một số lượng đáng kể điểm A và B (80, 90 và 100). Biểu đồ histogram hiển thị rõ điều này. Biểu đồ hộp cho chúng ta thấy rằng 50% điểm thi ở giữa (*IQR* = 29) là điểm D, C và B. Biểu đồ hộp cũng cho chúng ta thấy rằng 25% điểm thi thấp nhất là điểm D và F.
...
Cũng giống như chúng ta không thể tìm thấy số trung bình chính xác, chúng ta cũng không thể tìm thấy độ lệch chuẩn chính xác. Hãy nhớ rằng độ lệch chuẩn mô tả bằng số độ lệch kỳ vọng mà một giá trị dữ liệu có so với số trung bình. Nói một cách đơn giản, độ lệch chuẩn cho phép chúng ta so sánh mức độ "bất thường" của dữ liệu cá nhân so với số trung bình.
...
Bảng giúp dễ dàng sử dụng công thức để tính độ lệch chuẩn của một bảng tần số đã nhóm:
...
- Đối với mỗi giá trị dữ liệu, hãy tính toán xem giá trị đó cách số trung bình bao nhiêu độ lệch chuẩn.
...
Hai vận động viên bơi lội, Angie và Beth, từ các đội khác nhau, muốn tìm ra ai có thời gian bơi nhanh nhất ở cự ly 50 mét tự do khi so sánh với đội của cô ấy. Vận động viên nào có thời gian nhanh nhất khi so sánh với đội của cô ấy?
