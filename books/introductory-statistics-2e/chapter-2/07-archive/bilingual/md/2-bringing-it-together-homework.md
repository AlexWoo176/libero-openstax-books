...
1. What percentage of the community is under age 35?
1. Bao nhiêu phần trăm cộng đồng dưới 35 tuổi?
1. Which box plot most resembles the information above?
...
|  |  | Javier | Javier | Ercilia | Ercilia |
| --- | --- | --- | --- | --- | --- |
| ̅̅̅̅̅𝑥x¯x¯ | ̅̅̅̅̅𝑥x¯x¯ | 6.0 miles | 6,0 dặm | 6.0 miles | 6,0 dặm |
| 𝑠ss | 𝑠ss | 4.0 miles | 4,0 dặm | 7.0 miles | 7,0 dặm |

1. How can you determine which survey was correct ?
1. Làm thế nào bạn có thể xác định cuộc khảo sát nào là chính xác?
1. Explain what the difference in the results of the surveys implies about the data.
...
![This shows two histograms. The first histogram shows a fairly symmetrical distribution with a mode of 6. The second histogram shows a uniform distribution.](../../../assets/img-2-2.webp)
...
| Number of years | Số năm | Frequency | Tần số | Number of years | Số năm | Frequency | Tần số |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 7 | 7 | 1 | 1 | 22 | 22 | 1 | 1 |
| 14 | 14 | 3 | 3 | 23 | 23 | 1 | 1 |
| 15 | 15 | 1 | 1 | 26 | 26 | 1 | 1 |
...
1. Find the sample mean ̅̅̅̅̅𝑥x¯x¯.
1. Tìm số trung bình mẫu ̅̅̅̅̅𝑥x¯x¯.
1. Find the approximate sample standard deviation, *s*.
...
1. Find the sample mean –𝑥x–x–
1. Tìm số trung bình mẫu –𝑥x–x–
1. Find the sample standard deviation, *s*
...
1. The middle 50% of the weights are from _______ to _______.
1. 50% trọng lượng ở giữa nằm trong khoảng từ _______ đến _______.
1. If our population were all professional football players, would the above data be a sample of weights or the population of weights?  Why?
...
the population mean, *μ*.số trung bình quần thể, *μ*.
the population standard deviation, *σ*.độ lệch chuẩn quần thể, *σ*.
the weight that is two standard deviations below the mean.trọng lượng thấp hơn số trung bình hai độ lệch chuẩn.
When Steve Young, quarterback, played football, he weighed 205 pounds.  How many standard deviations above or below the mean was he?Khi Steve Young, một cầu thủ tiền vệ, chơi bóng bầu dục, anh ấy nặng 205 pound. Anh ấy cao hơn hay thấp hơn số trung bình bao nhiêu độ lệch chuẩn?
1. That same year, the mean weight for the Dallas Cowboys was 240.08 pounds with a standard deviation of 44.38 pounds.  Emmit Smith weighed in at 209 pounds.  With respect to his team, who was lighter, Smith or Young?  How did you determine your answer?
...
1. What is the standard deviation for this population?
1. Độ lệch chuẩn cho quần thể này là bao nhiêu?
1. What is the median change score?
1. Điểm thay đổi trung vị là bao nhiêu?
1. Find the change score that is 2.2 standard deviations below the mean.
1. Tìm điểm thay đổi thấp hơn số trung bình 2,2 độ lệch chuẩn.
Refer to [Figure 2.51](2-bringing-it-together-homework#fs-idm70725344) determine which of the following are true and which are false. Explain your solution to each part in complete sentences.
...
1. We cannot determine if any of the means for the three graphs is different.
1. Chúng ta không thể xác định liệu bất kỳ số trung bình nào trong ba biểu đồ có khác nhau hay không.
1. The standard deviation for graph b is larger than the standard deviation for graph a.
1. Độ lệch chuẩn cho biểu đồ b lớn hơn độ lệch chuẩn cho biểu đồ a.
1. We cannot determine if any of the third quartiles for the three graphs is different.
...
1. Find the median, the first quartile, and the third quartile.
1. Tìm trung vị, tứ phân vị thứ nhất và tứ phân vị thứ ba.
1. Find the 65^th percentile.
1. Tìm bách phân vị thứ 65^th.
1. Find the 10^th percentile.
1. Tìm bách phân vị thứ 10^th.
1. Construct a box plot of the data.
1. Vẽ biểu đồ hộp của dữ liệu.
1. The middle 50% of the conferences last from _______ days to _______ days.
1. 50% ở giữa của các hội nghị kéo dài từ _______ ngày đến _______ ngày.
1. Calculate the sample mean of days of engineering conferences.
1. Tính số trung bình mẫu của số ngày diễn ra các hội nghị kỹ thuật.
1. Calculate the sample standard deviation of days of engineering conferences.
1. Tính độ lệch chuẩn mẫu của số ngày diễn ra các hội nghị kỹ thuật.
1. Find the mode.
1. Tìm yếu vị.
1. If you were planning an engineering conference, which would you choose as the length of the conference: mean; median; or mode? Explain why you made that choice.
...
1. Give two reasons why you think that three to five days seem to be popular lengths of engineering conferences.
...
1. Organize the data into a chart with six intervals of equal width from 0 to 30,000. Label the two columns "Enrollment" and "Frequency."
...
1. Construct a histogram of the data.
1. Vẽ biểu đồ histogram của dữ liệu.
1. If you were to build a new community college, which piece of information would be more valuable: the mode or the mean?
...
1. A school with an enrollment of 8000 would be how many standard deviations away from the mean?
...
Suppose that a publisher conducted a survey asking adult consumers the number of fiction paperback books they had purchased in the previous month. The results are summarized in the [Table 2.84](2-bringing-it-together-homework#table23).
...
1. If a data value is identified as an outlier, what should be done about it?
1. Nếu một giá trị dữ liệu được xác định là giá trị ngoại lệ, chúng ta nên xử lý nó như thế nào?
1. Are any data values further than two standard deviations away from the mean? In some situations, statisticians may use this criteria to identify data values that are unusual, compared to the other data values. (Note that this criteria is most appropriate to use for data that is mound-shaped and symmetric, rather than for skewed data.)
...
1. Do parts a and c of this problem give the same answer?
1. Các phần a và c của bài toán này có cho cùng một câu trả lời không?
1. Examine the shape of the data.  Which part, a or c, of this question gives a more appropriate result for this data?
1. Kiểm tra hình dạng của dữ liệu. Phần nào, a hay c, của câu hỏi này đưa ra kết quả phù hợp hơn cho dữ liệu này?
1. Based on the shape of the data which is the most appropriate measure of center for this data: mean, median or mode?
