...
Total = 56+24+24+6110=110110=156+24+24+6110=110110=156+24+24+6110=110110=1*
...
*P*(*RB* OR *BR*) = (311)⁢(810)⁢ + (___)(___) = ⁢48110(311)⁢(810)⁢ + (___)(___) = ⁢48110(311)(810) + (___)(___) = 48110
...
*P*(*R* on 1st AND *B* on 2nd) = *P*(*RB*) = (___)(___) = 241102411024110
...
1. Find *P*(*N*|*F*).
1. Tìm *P*(*N*|*F*).
1. Find *P*(at most one face card).
...
1. Find *P*(at least one face card).
...
a.(12)⁢(12)(12)⁢(12)(12)(12) b.(49)⁢(49)(49)⁢(49)(49)(49) c.(49)⁢(38)(49)⁢(38)(49)(38) d.(49)⁢(59)(49)⁢(59)(49)(59)
1. What is the probability that one kitten of each coloring is selected?
...
a.(49)⁢(59)(49)⁢(59)(49)(59) b.(49)⁢(58)(49)⁢(58)(49)(58) c.(49)⁢(59)+(59)⁢(49)(49)⁢(59)+(59)⁢(49)(49)(59)+(59)(49)	d.(49)⁢(58)+(59)⁢(48)(49)⁢(58)+(59)⁢(48)(49)(58)+(59)(48)
1. What is the probability that a tabby is chosen as the second kitten when a black kitten was chosen as the first?
...
1. What is the probability of choosing two kittens of the same color?
...
1. *P*(*R*) = ___________
1. *P*(*R*) = ___________
1. *P*(*O* AND *R*) = ___________
1. *P*(*O* biến cố "và" *R*) = ___________
1. *P*(*O* OR *R*) = ____________
1. *P*(*O* biến cố "hoặc" *R*) = ____________
1. In the Venn Diagram, describe the overlapping area using a complete sentence.
1. Trong sơ đồ Venn, hãy mô tả vùng chồng lấp bằng một câu hoàn chỉnh.
1. In the Venn Diagram, describe the area in the rectangle but outside both the circle and the oval using a complete sentence.
...
1. Find the probability that the customer buys either a novel or a non-fiction book.
1. Tìm xác suất để khách hàng mua tiểu thuyết hoặc sách phi hư cấu.
1. In the Venn diagram, describe the overlapping area using a complete sentence.
1. Trong sơ đồ Venn, hãy mô tả vùng chồng lấp bằng một câu hoàn chỉnh.
1. Suppose that some customers buy only compact disks. Draw an oval in your Venn diagram representing this event.
