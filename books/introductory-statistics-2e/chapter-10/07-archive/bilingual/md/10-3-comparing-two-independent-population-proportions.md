...
1. The number of successes is at least five, and the number of failures is at least five, for each of the samples.
1. Số lượng thành công ít nhất là năm, và số lượng thất bại ít nhất là năm, cho mỗi mẫu.
1. Growing literature states that the population must be at least ten or 20 times the size of the sample. This keeps each population from being over-sampled and causing incorrect results.
...
|  |  | Men | Nam | Women | Nữ |
| --- | --- | --- | --- | --- | --- |
| Does not wear seat belts | Không thắt dây an toàn | 183 | 183 | 156 | 156 |
| Total number surveyed | Tổng số người được khảo sát | 2231 | 2231 | 2169 | 2169 |
...
| Men | Nam | Women | Nữ |
| --- | --- | --- | --- |
| **Favor tea** | **Thích trà** | 16 | 16 |
| **Total surveyed** | **Tổng số được khảo sát** | 230 | 230 |
