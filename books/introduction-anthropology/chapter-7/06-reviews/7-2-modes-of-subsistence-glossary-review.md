# Báo cáo Kiểm tra Thuật ngữ: 7-2-modes-of-subsistence.html

**File kiểm tra:** `chapter-7/05-translated/7-2-modes-of-subsistence.html`
...
|---|---|---|---|
| `mode of subsistence` | `phương thức sinh kế` | `phương thức sinh kế` | ✅ |
